...
export class Conversation
  ...
  handleScroll(e: any) {
    ...
    if (this.vm.lastMessage) {
      this.vm.lastLocalMessageElement = document.getElementById(
        this.vm.lastMessage?.clientMsgNo
      ); // 最新消息
                ...
                <div className="wk-conversation-footer">
                  <div className="wk-conversation-footer-content">
                    <MessageInput
                      ...
                      context={this}
                      onSend={(text: string, mention?: MentionModel) => {
                  ...
                  >
                    {this.getReminderIcon(type) ? (
                      loading.get(type) ? (
                        ...
                        <img
                          src={require(`${this.getReminderIcon(type)}`)}
                        ></img>
                      )
                    ) : undefined}
