...
export default class ConversationSelect extends Component<
  ConversationSelectProps,
  ConversationSelectState
> {
  ...
  render() {
    ...
    return (
      <div className="yw-conversationselect">
        <div>
          <div className="yw-conversationselect-content-title">
            {title || "转发"}
          </div>
          <div
            id="conversationSelectSearchBox"
            className="yw-conversationselect-content-searchBox"
          >
            <div className="yw-conversationselect-content-selectedChannel">
              {selectChannels.map((channel: Channel) => {
                return (
                  <div
                    key={`${channel.channelID}-selected`}
                    className="yw-conversationselect-content-selectedAvatar"
                    onClick={() => {
                      this.select(channel);
                    }}
                  >
              ...
              <div className="yw-conversationselect-content-searchContent">
                <div className="yw-conversationselect-content-searchIcon">
                  <IconSearchStroked
                    style={{ color: "#bbbfc4", fontSize: "20px" }}
                  />
                </div>
                <div className="yw-conversationselect-content-searchInput">
                  <input
                    placeholder="搜索"
                    type="text"
                    style={{ fontSize: "17px" }}
          ...
          <div className="yw-conversationselect-content-box">
            <div className="yw-conversationselect-content-header">最近聊天</div>
            <div className="yw-conversationselect-content-list">
              {sortedConversations
                .filter((v) => {
                  if (!keyword || keyword === "") {
                    return true;
                ...
                .map((conversationWrap: ConversationWrap) => {
                  return (
                    <div
                      key={`${conversationWrap.channel.channelID}-conversation`}
                      className="yw-conversationselect-content"
                      onClick={() => {
                    ...
                    >
                      <div>
                        <Checkbox
                          checked={this.hasSelected(conversationWrap.channel)}
                          onCheck={() => {
                            this.select(conversationWrap.channel);
                          }}
                        />
                      </div>
                      <div className="yw-conversationselect-content-box-data">
                        <div>
                          <WKAvatar
                        ...
                        <div className="yw-conversationselect-content-box-name">
            ...
            <div className="yw-conversationselect-content-header">好友</div>
            <div className="yw-conversationselect-content-list">
              {friends
                .filter((v) => {
                  if (!keyword || keyword === "") {
                ...
                .map((channelInfo: ChannelInfo) => {
                  return (
                    <div
                      key={channelInfo.channel.channelID}
                      className="yw-conversationselect-content"
                      onClick={() => {
                    ...
                    >
                      <div>
                        <Checkbox
                          checked={this.hasSelected(channelInfo.channel)}
                          onCheck={() => {
                            this.select(channelInfo.channel);
                          }}
                        />
        ...
        <div className="yw-conversationselect-footer">
          <div
            className="yw-conversationselect-okBtn"
            onClick={() => {
              if (onFinished) {
