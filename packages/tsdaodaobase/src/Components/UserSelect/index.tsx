...
export class ContactsSelect extends Component<ContactsSelectProps> {
  ...
  render() {
    const {
      ...
      onFinished,
      onBack,
      onFinishButtonContext,
      showFinishButton,
    } = this.props;
    return (
      <div className="yw-contactsselect">
        {showHeader ? (
          <WKViewQueueHeader
        ...
        <div className="yw-contactsselect-content">
          <UserSelect
            disableSelectList={disableSelectList}
            onSelect={(items) => {
              if (showHeader) {
            ...
            users={WKApp.dataSource.contactsList
