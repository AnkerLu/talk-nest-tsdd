      ...
      <div className="yw-layout">
        ...
        <div
          className={classNames(
            "yw-layout-content",
            this.rightContext?.viewCount() > 0 ? "yw-layout-open" : undefined
          )}
        >
          <div className="yw-layout-content-left">
            <WKViewQueue
              onContext={(context) => {
                if (onLeftContext) {
          ...
          <div className="yw-layout-content-right">
            <WKViewQueue
              onContext={(context) => {
