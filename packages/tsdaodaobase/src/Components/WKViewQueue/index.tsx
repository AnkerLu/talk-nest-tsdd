...
export default class WKViewQueue
  extends Component<WKViewQueueProps, WKViewQueueState>
  implements WKViewQueueContext
{
  ...
  statusClass() {
    ...
    if (status === WKViewQueueStatus.Push) {
      return "yw-viewqueue-view-in";
    } else if (status === WKViewQueueStatus.Pop) {
      return "yw-viewqueue-view-out";
    } else {
      return "";
    }
  }
  ...
  render(): ReactNode {
    const { queues } = this.state;
    return (
      <div className="yw-viewqueue">
        <div className="yw-viewqueue-route">
          <div className="yw-viewqueue-view">{this.props.children}</div>
          {queues.map((view, i) => {
            ...
            return (
              <div
                ...
                id={last ? "yw-viewqueue-view-last" : undefined}
                className={classNames(
                  "yw-viewqueue-view",
                  last ? this.statusClass() : undefined
                )}
              >
                {view}
              </div>
