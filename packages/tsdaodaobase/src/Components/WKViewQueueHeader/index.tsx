  ...
  implements FinishButtonContext
{
  ...
  render(): ReactNode {
    ...
    return (
      <div className="yw-viewqueueheader">
        {hideBack ? undefined : (
          <div
            className="yw-viewqueueheader-back"
            onClick={() => {
              if (onBack) {
                onBack();
              }
        ...
        <div className="yw-viewqueueheader-content">
          <div className="yw-viewqueueheader-content-title">{title}</div>
          {showFinishButton ? (
