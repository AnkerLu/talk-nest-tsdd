    ...
    return (
      <MessageBase hiddeBubble={true} message={message} context={context}>
        <div
          ...
          style={{ width: actSize.width, height: "100%" }}
        >
          <div className="wk-message-video-content">
            <span className="wk-message-video-content-time">
              {this.secondFormat(content.second - playProgress)}
            </span>
            <div className="wk-message-video-content-video">
              <video
                poster={WKApp.dataSource.commonDataSource.getImageURL(
                  content.cover
                )}
                width={actSize.width}
              ...
              >
                <source
                  src={WKApp.dataSource.commonDataSource.getFileURL(videoUrl)}
                  type="video/mp4"
                />
              </video>
            </div>
