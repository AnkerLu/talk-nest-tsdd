import { WKApp, WKViewQueueHeader, QRCodeMy, Search } from "@yuwo/base";
import { WKBase, WKBaseContext } from "@yuwo/base";
...
export class FriendAdd extends Component<FriendAddProps, FriendAddState> {
  ...
  render(): ReactNode {
    ...
    return (
      ...
      >
        <div className="yw-friendadd">
          <WKViewQueueHeader title="添加好友" onBack={onBack} />
          <div className="yw-friendadd-content">
            ...
            <div className="yw-friendadd-content-qrcode">
